...
# Run `pod lib lint flutter_volume_listener.podspec` to validate before publishing.
#
Pod::Spec.new do |s|
...
A Flutter plugin to read volume and listen to volume changes on iOS.
  ...
  # s.resource_bundles = {'flutter_volume_listener_privacy' => ['Resources/PrivacyInfo.xcprivacy']}
end
